...
<body>
  ...
  <!-- Invitación flotante opcional -->
  <div class="floating-invite" role="status" aria-live="polite">
    <div style="font-weight:700">¿Listo para jugar?</div>
    <button class="btn play" style="margin-left:6px;" onclick="location.href='#juego'">Ir</button>
  </div>
